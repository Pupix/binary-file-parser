/*jslint stupid: true, regexp:true, browser: true, devel: true, node: true, ass: true, nomen: true, unparam: true, indent: 4 */
...
(function () {
    ...
    module.exports = new XP.Class('Parser', {
        ...
        initialize: function (opt) {
            ...
            //Setting file size and reader mode
            ...
            if (opt.chunkSize) {
                self.chunk_.size = opt.chunkSize;
            }
            ...
            //Opening up the file
            self.fileDescriptor_ = fs.openSync(filePath, 'r');
            self.setChunk_();
        ...
        readFunction_: function (struct, index) {
            ...
            return struct.call(self, self.getCache(), index);
        },
        ...
        readObject_: function (struct) {
            ...
            XP.forOwn(struct, function (value, key) {
                ...
                //Inline function must have `return` to work FIXME

                if (read !== undefined && !key.match(irrelevantKeys)) {
                    output[key] = read;
        ...
        setChunk_: function () {
            ...
            fs.readSync(self.fileDescriptor_, self.chunk_.buffer, 0, self.chunk_.size, self.offset_);
